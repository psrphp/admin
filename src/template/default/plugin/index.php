        ...
        <div>
            ...
            <div>
                ...
                <div style="display: flex;flex-wrap: column;gap: 5px;">
                    <form action="{echo $router->build('/psrphp/admin/plugin/disable')}" method="POST">
        ...
        <div>
            ...
            <div>
                ...
                <div style="display: flex;flex-wrap: column;gap: 5px;">
                    ...
                    <form action="{echo $router->build('/psrphp/admin/plugin/un-install')}" method="POST">
                        <input type="hidden" name="name" value="{$vo.name}">
    ...
    <div style="display: flex;flex-direction: row;flex-wrap: wrap;gap: 10px;">
        ...
        <div>
            ...
            <div>
                ...
                <div><code>{$vo.name}</code> </div>
                <div style="display: flex;flex-wrap: column;gap: 5px;">
                    <form action="{echo $router->build('/psrphp/admin/plugin/install')}" method="POST">
                        <input type="hidden" name="name" value="{$vo.name}">
                        <button type="submit">安装该插件</button>
                    </form>
                    <form action="{echo $router->build('/psrphp/admin/plugin/delete')}" method="POST">
                        <input type="hidden" name="name" value="{$vo.name}">
